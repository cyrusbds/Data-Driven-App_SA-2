...
class PokeApp:
    ...
    def create_menu(self):
        ...
        tk.Button(self.menu_frame, text="Random", font=("Helvetica", 12), width=15, command=self.random_poke).place(x=200,y=300)
    ...
    def create_app(self):
        ...
        tk.Button(self.top_frame, text="Randomize", font=("Helvetica", 10), command=self.random_poke, bg="black", fg="white").place(x=705, y=10)
    ...
    def random_poke(self):
        ...
        random_info = {
            ...
            'stats': {stat['stat']['name'].capitalize(): stat['base_stat'] for stat in randomData['stats']},
    ...
    def get_poke_info(self):
        ...
        if pokemon_name:
            ...
            if pokemon_info:
                ...
                messagebox.showerror("Error: Invalid Pokemon or ID", f"{pokemon_name} is not a valid Pokemon Name or ID Number")
        else:
            messagebox.showerror("Error: Invalid Pokemon or ID", "Please Enter a Pokemon Name or ID Number")
